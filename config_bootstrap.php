...
if(!defined('NSM_ENV')) {
    ...
    define('NSM_BASEPATH', $_SERVER['DOCUMENT_ROOT']);
    define('NSM_SYSTEM_FOLDER', 'liza');
...
elseif(NSM_ENV == 'mobile') {
    ...
    $env_db_config = array(
        'hostname' => '216.70.69.81',
        'username' => 'artmatters_ee',
        'password' => '',
        'database' => 'artmatters_ee',
    );
    $env_global_vars = array(
...
if(isset($config)) {
    ...
    */
    ...
    $default_global_vars = array(
        ...
        'global:env'                    => NSM_ENV,
        'global:host_name' => NSM_SERVER_NAME,
        'global:ssl' => SSL,
        ...
        // NSM Gravatar
        'global:nsm_gravatar_default_avatar' => NSM_SITE_URL . '/avatars/default.png',
    ...
    $default_config = array(
        ...
        'third_party' => NSM_BASEPATH . '/liza/expressionengine/third_party/',
        ...
        'prv_msg_upload_path' => NSM_BASEPATH . '/images/pm_attachments',
        'enable_emoticons' => 'n',
        ...
        'captcha_path' => NSM_BASEPATH . '/images/'.NSM_SYSTEM_FOLDER.'/images/captchas/',
...
$config['ce_image_aws_key'] = '017YBYNZGR3HVZ600X02';
$config['ce_image_aws_secret_key'] = 'qxbQK061zbEB2dFws7WOYtrqU6rYOuUyCnM0T9hY';
$config['ce_image_bucket'] = 'visualaids_galleries';
